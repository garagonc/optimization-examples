...
# Variables
#
model.x=Var(model.I,model.T,within=NonNegativeReals)       #First stage variables:  x[i,t]: Quantity of raw material i purchased for use in period t
model.y=Var(model.J,model.T,within=NonNegativeReals)       #Second stage variables: y[j,t]: Quantity of product j outsourced in period t 
