...
ess_domain=[20,30,40,50,60,70]
ev_domain=[30,40,50,60,70]


dynprog=StochasticDynamicProgram(scenario_24Ts,ess_domain,ev_domain,opt3,1,prob_plug,prob_end_soc)
"""
