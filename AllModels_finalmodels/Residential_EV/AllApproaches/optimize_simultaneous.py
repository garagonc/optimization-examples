# -*- coding: utf-8 -*-
"""
Created on Fri Aug 17 09:00:44 2018
...
from Simultaneous.RealCapacity_maxPV_withoutGesscon import MaximizePV


def optimize_simultaneously(year,month,day,
                  timeresolution,
                  horizon,
                  solver,
                  ev_capacity,
    ...
    for t in range(horizon):
        ...
        EMOptimizer=MaximizePV(timeresolution,horizon,solver,
                               ...
                               ess_capacity,essSoCdomain,essDecisionDomain,
