# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 09:57:30 2018
...
class MinimizePImport():
    """
    Class for the abstract optimization model
    Objective: Minimization of active power input from the grid)
    ...
    def build_abstract_model_withoutParameters(self):
        ...
        ###########################################################################
        def obj_rule(model):  
            return sum(model.local_weight[t]*model.P_Grid_Output[t]
...
if __name__=="__main__":
    ...
    optimizationmodel=MinimizePImport()
    ...
    with open('quadratic_MinimizePImport.csv','w') as file:
        for ts in range(24):
