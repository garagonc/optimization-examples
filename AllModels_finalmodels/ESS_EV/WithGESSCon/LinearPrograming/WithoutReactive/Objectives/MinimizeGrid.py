# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 09:20:54 2018
...
class MinimizePowerExchange():
    ...
    def build_abstract_model_withoutParameters(self):
        ...
        ###########################################################################
        def obj_rule(model):  
            return sum(model.local_weight[t]*model.P_Grid_Output[t]*model.P_Grid_Output[t]
...
if __name__=="__main__":
    ...
    with open('linear_MinimizePowerExchange.csv','w') as file:
        for ts in range(24):
