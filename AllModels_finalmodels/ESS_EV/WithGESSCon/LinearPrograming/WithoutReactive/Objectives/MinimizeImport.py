# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 09:31:27 2018
...
class MinimizeImport():
    ...
    Objective: Minimization of power import from the grid
    ...
    def build_abstract_model_withoutParameters(self):
        ...
        model.P_Grid_Output=Var(model.T,within=Reals,bounds=(0,100000))  
...
if __name__=="__main__":
    ...
    with open('linear_MinimizePowerImport.csv','w') as file:
        for ts in range(24):
