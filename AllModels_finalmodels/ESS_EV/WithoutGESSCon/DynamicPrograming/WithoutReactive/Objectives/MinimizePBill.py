...
class DynamicMinimizePBill():
    ...
    def optimaldecisioncalculator(self,timestep,initialsoc):
        ...
        def objrule1(model):
            return self.Price_Forecast[timestep]*model.P_GRID+sum(model.Decision[x]*self.Value[timestep+1,initialsoc+x] for x in model.decision_ess)
...
if __name__=="__main__":
    ...
    dynprog_opt3=DynamicMinimizePBill(scenario_24Ts,ess_soc_domain,decision_domain,opt3)
