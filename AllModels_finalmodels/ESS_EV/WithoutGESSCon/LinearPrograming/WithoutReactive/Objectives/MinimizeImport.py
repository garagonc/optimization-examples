# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 09:34:19 2018
...
class MinimizeImport():
    ...
    Objective: Minimization of power import from grid
    Solvers  : "glpk","bonmin","ipopt"
    """
...
if __name__=="__main__":
    ...
    optimizationmodel=MinimizeImport()
    ...
    with open('linear_MinimizeImport.csv','w') as file:
        for ts in range(24):
