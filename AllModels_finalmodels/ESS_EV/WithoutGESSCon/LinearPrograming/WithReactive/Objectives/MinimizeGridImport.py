# -*- coding: utf-8 -*-
"""
Created on Tue Jun 26 09:36:39 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 30 14:59:27 2018
...
class MinimizePowerImport():
    """
    Class for the abstract optimization model
    Objective: Minimization of the power import from the grid
    ...
    def build_abstract_model_withoutParameters(self):
        ...
        model.P_Grid_Output=Var(model.T,within=Reals,bounds=(0,100000))                                 #Active power exchange with grid
        ...
        ###########################################################################
        def obj_rule(model):  
            return sum(model.P_Grid_Output[t] for t in model.T)
    ...
    def calculateOptimalTrajectory(self,data_file,solver):
        ...
        for t in instance.T:
            ...
            self.Q_PV.append(instance.Q_PV_Output[t]())
            self.P_GRID.append(instance.P_Grid_Output[t]())
            self.Q_GRID.append(instance.Q_Grid_Output[t]())
            for n in instance.N:
...
if __name__=="__main__":
    ...
    optimizationmodel=MinimizePowerImport()
    ...
    data_file=project_dir+'/ScenarioQ.dat'
    ...
    with open('quadratic_MinimizePowerImport.csv','w') as file:
        for ts in range(24):
            ...
            file.write(",")
            file.write(str(optimizationmodel.Q_PV[ts]))            
            file.write(",")
            file.write(str(optimizationmodel.Q_GRID[ts]))
            file.write('\n')
