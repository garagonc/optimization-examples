...
from WithGESSCon.LinearPrograming.WithoutReactive.Objectives.MinimizeGrid import MinimizePowerExchange as optmodel
...
opt3= SolverFactory("bonmin", executable="C:/cygwin/home/bonmin/Bonmin-1.8.6/build/bin/bonmin")
optimizationmodel.calculateOptimalTrajectory('optimization_withoutReactive/Scenarios/scenario_lp_wGessConn_0_50.dat',opt3)
