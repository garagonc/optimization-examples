...
###########
###########################################################################
print("Optimization objective: Minimize import")
...
from optimization_withoutReactive.Models.woGessConn_minPowImport_lp import schedules as schedule_woLp
from optimization_withoutReactive.Models.wGessConn1_minPowImport_lp import schedules as schedule_wLp
from optimization_withoutReactive.Models.woGessConn_minPowImport_dp import schedules as schedule_woDp
from optimization_withoutReactive.Models.wGessConn1_minPowImport_dp import schedules as schedule_wDp
...
results_lp_woGessConn_obj1=simulate_a_schedule(schedule_woLp,"LP optimized without GessConn Command")
results_lp_wGessConn_obj1=simulate_a_schedule(schedule_wLp,"LP optimized with GessConn Command")
results_dp_woGessConn_obj1=simulate_a_schedule(schedule_woDp,"DP optimized without GessConn Command")
results_dp_wGessConn_obj1=simulate_a_schedule(schedule_wDp,"DP optimized with GessConn Command")
