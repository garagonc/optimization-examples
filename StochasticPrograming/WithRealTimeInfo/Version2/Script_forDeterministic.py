...
for t in range(24):      
    ...
    P_PV_1.append(scenario1.P_PV_Output_ini[t]()                if t<=1 else scenario1.P_PV_Output_rec[t]())
    P_Grid_1.append(scenario1.P_Grid_Output_ini[t]()            if t<=1 else scenario1.P_Grid_Output_rec[t]())
    P_ESS_1.append(scenario1.P_ESS_Output_ini[t]()              if t<=1 else scenario1.P_ESS_Output_rec[t]())
    P_EV_HomeCharge_1.append(scenario1.P_EV_ChargeHome_ini[t]() if t<=1 else scenario1.P_EV_ChargeHome_rec[t]())
    P_EV_AwayCharge_1.append(scenario1.P_EV_ChargeAway_ini[t]() if t<=1 else scenario1.P_EV_ChargeAway_rec[t]())
    ...
    P_PV_2.append(scenario2.P_PV_Output_ini[t]()                if t<=1 else scenario2.P_PV_Output_rec[t]())
    P_Grid_2.append(scenario2.P_Grid_Output_ini[t]()            if t<=1 else scenario2.P_Grid_Output_rec[t]())
    P_ESS_2.append(scenario2.P_ESS_Output_ini[t]()              if t<=1 else scenario2.P_ESS_Output_rec[t]())
    P_EV_HomeCharge_2.append(scenario2.P_EV_ChargeHome_ini[t]() if t<=1 else scenario2.P_EV_ChargeHome_rec[t]())
    P_EV_AwayCharge_2.append(scenario2.P_EV_ChargeAway_ini[t]() if t<=1 else scenario2.P_EV_ChargeAway_rec[t]())
    ...
    P_PV_3.append(scenario3.P_PV_Output_ini[t]()                if t<=1 else scenario3.P_PV_Output_rec[t]())
    P_Grid_3.append(scenario3.P_Grid_Output_ini[t]()            if t<=1 else scenario3.P_Grid_Output_rec[t]())
    P_ESS_3.append(scenario3.P_ESS_Output_ini[t]()              if t<=1 else scenario3.P_ESS_Output_rec[t]())
    P_EV_HomeCharge_3.append(scenario3.P_EV_ChargeHome_ini[t]() if t<=1 else scenario3.P_EV_ChargeHome_rec[t]())
    P_EV_AwayCharge_3.append(scenario3.P_EV_ChargeAway_ini[t]() if t<=1 else scenario3.P_EV_ChargeAway_rec[t]())
