# -*- coding: utf-8 -*-
"""
Created on Thu Apr 26 17:08:51 2018
...
os.chdir(r'C:/Users/guemruekcue/internship/optimization-agent/dssInterface/tests/LinearVsDynamic_withoutQ')

csv_file='linear_MaximizePV.csv'
pv_sch=[]
ess_sch=[]
imp_sch=[]
...
maxPVLin = pandas.DataFrame(list(zip(timestamp, v1, SOCProfile,load_profile,pv_power_profile,imp_sch)), columns=['time','Voltage','SoC','Load','PV','Import'])