# -*- coding: utf-8 -*-
"""
Created on Fri Apr 27 09:16:35 2018
...
csv_file='dynamic_MinimizePBill.csv'
pv_sch=[]
ess_sch=[]
imp_sch=[]
...
minPBillDyn = pandas.DataFrame(list(zip(timestamp, v1, SOCProfile,load_profile,pv_power_profile,imp_sch)), columns=['time','Voltage','SoC','Load','PV','Import'])
