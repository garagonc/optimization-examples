...
csv_file='dynamic_MaximizePV.csv'
pv_sch=[]
ess_sch=[]
imp_sch=[]
...
maxPVDyn = pandas.DataFrame(list(zip(timestamp, v1, SOCProfile,load_profile,pv_power_profile,imp_sch)), columns=['time','Voltage','SoC','Load','PV','Import'])
