# -*- coding: utf-8 -*-
"""
Created on Fri Apr 27 09:09:28 2018
...
csv_file='quadratic_MaximizePV.csv'
p_pv_sch=[]
q_pv_sch=[]
ess_sch=[]
p_imp_sch=[]
...
maxPVQuad = pandas.DataFrame(list(zip(timestamp, v1, SOCProfile,load_profile,pv_p_power_profile,pv_q_power_profile,p_imp_sch,q_imp_sch)), columns=['time','Voltage','SoC','Load','P_PV','Q_PV','P_Import','Q_Import'])
