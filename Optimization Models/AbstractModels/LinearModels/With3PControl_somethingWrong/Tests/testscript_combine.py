...
class MaximizePVUtilization():
    ...
    def __init__(self,iniSoC,iniVal):
        ...
        model.P_PV_Output=Var(model.T,within=NonNegativeReals,bounds=(0,model.PV_Inv_Max_Power),initialize=1300)
        model.P_ESS_Output = Var(model.T,within=Reals,bounds=(-model.ESS_Max_Charge_Power, model.ESS_Max_Discharge_Power),initialize=iniVal)        
...
writer = pd.ExcelWriter('combine_10AM.xlsx')
