# -*- coding: utf-8 -*-
"""
Created on Thu Jun 21 16:03:52 2018
...
class MinimizePowerBilll():
    ...
    def build_abstract_model_withoutParameters(self):
        ...
        model.absDeviation=Var(model.T,within=NonNegativeReals)
        ################################################################################################
...
if __name__=="__main__":
    ...
    data_file=project_dir+'/Scenario0.dat'
    ...
    with open('linear_MinimizeBill.csv','w') as file:
        for ts in range(24):
