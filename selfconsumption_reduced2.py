# -*- coding: utf-8 -*-
"""
Created on Mon Feb  5 14:50:23 2018
...
#Maximum utilization of PV potential
...
print("#################################################")  
def obj_rule(model):
    return sum(model.PVmod[m] for m in model.answers)
model.obj=Objective(rule=obj_rule, sense = maximize)
print("Objective is the maximization of PV potential")
